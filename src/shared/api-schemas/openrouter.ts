...
const OpenrouterMessagesSchema = z.array(OpenrouterChatMessageSchema);

// Basic chat completions schema
export const OpenrouterV1ChatCompletionsSchema = z.object({
  model: z.string(),
  messages: OpenrouterMessagesSchema,
...
export const OpenrouterV1ImageGenerationsSchema = z.object({
